...
func defaultGolden() (light, dark tokens.ColorTokens) {
	...
	light = tokens.ColorTokens{
		...
		Error:       hex(0xb1, 0x23, 0x22),
		OnError:     hex(0xff, 0xff, 0xff),
		Success:     hex(0x00, 0x6b, 0x1f),
		OnSuccess:   hex(0xff, 0xff, 0xff),
		Warning:     hex(0x89, 0x4d, 0x00),
		OnWarning:   hex(0xff, 0xff, 0xff),
		Info:        hex(0x00, 0x5e, 0xa5),
		OnInfo:      hex(0xff, 0xff, 0xff),
		Background:  hex(0xf1, 0xf1, 0xf1),
	...
	dark = tokens.ColorTokens{
		...
		Error:       hex(0xff, 0xbc, 0xb3),
		OnError:     hex(0x3a, 0x00, 0x02),
		Success:     hex(0x7a, 0xe2, 0x84),
		OnSuccess:   hex(0x00, 0x1d, 0x03),
		Warning:     hex(0xff, 0xbf, 0x86),
		OnWarning:   hex(0x28, 0x12, 0x00),
		Info:        hex(0xa4, 0xd0, 0xff),
		OnInfo:      hex(0x00, 0x18, 0x32),
